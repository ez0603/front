...
// ! 1. 배열이란?
// 배열(Array)은 여러 개의 값을 순차적으로 나열한 자료 구조
...
let lasFruit = fruits.pop();
console.log(lasFruit); // Cherry

// shift() : 배열의 첫 번째 요소를 제거, 그 요소를 반환
// - 빈 배열의 경우 undefind를 반환
...
let removeItems = fruits.splice(1, 1)
