...
// 콜백함수의 인자값 : 각 요소의 값, 인덱스 번호, 배열 그자체
cars.forEach((car) => { // car = 요소값
...
console.log(longNameCars); // [ 'hyundai', 'volvo' ] => 단어의 길이가 4보다 큰 단어들만 새로운 배열에 담김
...
// -선택값 
// currentIndex : 현재 처리중인 배열 요소의 인덱스
